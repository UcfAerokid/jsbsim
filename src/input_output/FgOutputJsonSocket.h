...
#ifndef FGOUTPUTJSONSOCKET_H
#define FGOUTPUTJSONSOCKET_H
...
class FGOutputJsonSocket : public FGOutputType
{
public:
  /** Constructor. */
	FGOutputJsonSocket(FGFDMExec* fdmex);

  /** Destructor. */
  ~FGOutputJsonSocket() override;
